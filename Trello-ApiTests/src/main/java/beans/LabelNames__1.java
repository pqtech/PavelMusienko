...
public class LabelNames__1 {
    ...
    public String toString() {
        ...
        sb.append(LabelNames__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("green");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LabelNames__1) == false) {
            return false;
        }
        LabelNames__1 rhs = ((LabelNames__1) other);
