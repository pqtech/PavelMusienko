...
public class TrelloBoardCreationAnswer {
    ...
    public String toString() {
        ...
        sb.append(TrelloBoardCreationAnswer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrelloBoardCreationAnswer) == false) {
            return false;
        }
        TrelloBoardCreationAnswer rhs = ((TrelloBoardCreationAnswer) other);
